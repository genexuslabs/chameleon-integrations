import { ChatMessageByRole } from "@genexus/chameleon-controls-library";
import {
  MarkdownViewerCodeRender,
  MarkdownViewerCodeRenderOptions
} from "@genexus/chameleon-controls-library/dist/types/components/markdown-viewer/parsers/types";
import { h } from "@stencil/core";

const copy = (text: string) => () => navigator.clipboard.writeText(text);

const mercuryCodeRender =
